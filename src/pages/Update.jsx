...
function Update() {
  ...
  const navigate = useNavigate();
    ...
    useEffect(()=>{
      axios.get('https://emserver-nxl8.onrender.com/home/'+id)
      .then(res => {
        setValues(res.data)
      })
    ...
    const handleUpdate=(event)=>{
      ...
      axios.put('https://emserver-nxl8.onrender.com/home/'+id,values)
      .then(res => {
        console.log(res);
        navigate('/home')
      })
  ...
  return (
    ...
    <div className='d-flex w-100 vh-100 justify-content-center align-items-center' style={{background: "#124E66"}}>
      <div className='border bg-white shadow px-5 pt-3 pb-5 rounded'>
        <h4 className='text-secondary d-flex justify-content-center align-items-center h4'>Edit Details</h4>
