...
function Create() {
    ...
    const handleSubmit = (event)=>{
      ...
      if(values.name && values.email && values.phone){
        axios.post('https://emserver-nxl8.onrender.com/home/',values)
        .then(res => {
        console.log(res);
        navigate('/')
        alert("Submitted")
  ...
  return (
    <>
      ...
      <div className=' border bg-white shadow px-5 pt-3 pb-5 rounded'>
        <h4 className='text-secondary d-flex justify-content-center align-items-center h4'>Add New Employee</h4>
