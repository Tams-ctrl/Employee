...
function Home() {
  ...
  useEffect(()=>{
    axios.get('https://emserver-nxl8.onrender.com/home/')
  ...
  const handleDelete=(id)=>{
    ...
    if(confirm){
      axios.delete('https://emserver-nxl8.onrender.com/home/'+id)
      .then (res =>{
        location.reload();
      }).catch(err => console.log(err))
    }
  ...
  return (
    ...
    <div className='container mt-5' >
      <h2 className='d-flex justify-content-center'>Employees</h2>

      {
        ...
        :
        <h3 className='text-danger text-center'>No employees Yet!!</h3>
      }
